...
if __name__ == "__main__":
    ...
    vis = Visualizer(save_dir="./saved_videos", pad_value=120, linewidth=3,tracks_leave_trace=1)
    vis.visualize(
        video, pred_tracks, pred_visibility, query_frame=args.grid_query_frame, filename='apple_online_1.mp4'
    )